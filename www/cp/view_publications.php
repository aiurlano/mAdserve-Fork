    ...
    <div id="content">
        ...
        <div class="container">
            ...
            <div class="grid-24">
                ...
                <div class="actions">
                    <button onclick="window.location='add_publication.php';" class="btn btn-quaternary"><span
                            class="icon-plus"></span>Create New Publication
                    </button>
                </div>
                <!-- .actions -->
