        ...
        <div class="container">
            ...
            <div class="grid-24">
                ...
                <?php if ($edited == 1) { ?>
                    <div class="box plain">
                        <div class="notify notify-success"><h3>Successfully Updated</h3>
                            ...
                            <p>Your Publisher ID Settings have successfully been updated.</p></div>
                        <!-- .notify --></div>
                ...
                <form method="post" id="publisher_id" name="publisher_id" class="form uniformForm">
                    ...
                    <?php if ($zone_active == 1) { ?>
                        <div style="margin-bottom:9px;"><a href="network_id_setup.php?id=<?php echo $_GET['id']; ?>">←
                            Back to Top Level</a></div><?php } ?>
                    ...
                    <div class="widget widget-table">
                        ...
                        <div class="widget-header">
                            ...
                            <h3 class="icon chart">Manage Publisher IDs<?php if ($zone_active == 1) {
                                    echo ': ' . $publication_detail['inv_name'] . '';
                                } ?></h3>
                        </div>
