                ...
                <?php if ($updated == 1) { ?>
                    <div class="box plain">
                        <div class="notify notify-success"><h3>Successfully Updated</h3>
                            ...
                            <p>Your Profile has successfully been updated.</p></div>
                        <!-- .notify --></div>
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-content">
                            ...
                            <div class="field-group">
                                <div class="field">
                                    <input type="text" value="<?php echo $user_detail['first_name']; ?>"
                                           name="first_name" id="first_name" size="10" class=""/>
                                    <label for="first_name">First Name</label>
                                </div>
                                <div class="field">
                                    <input type="text" value="<?php echo $user_detail['last_name']; ?>" name="last_name"
                                           id="last_name" size="10" class=""/>
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    <input type="text" value="<?php echo $user_detail['email_address']; ?>"
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    <input type="text" value="<?php echo $user_detail['company_name']; ?>"
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    <input type="text" value="<?php echo $user_detail['phone_number']; ?>"
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    <input type="text" value="<?php echo $user_detail['fax_number']; ?>"
                            ...
                            <div class="field-group">
                                <div class="field">
                                    <input type="text" value="<?php echo $user_detail['company_address']; ?>"
                                           name="company_address" id="company_address" size="20" class=""/>
                                    <label for="company_address">Address</label>
                                </div>
                                <div class="field">
                                    <input type="text" value="<?php echo $user_detail['company_city']; ?>"
                            ...
                            <div class="field-group">
                                <div class="field">
                                    <input type="text" value="<?php echo $user_detail['company_state']; ?>"
                                           name="company_state" id="company_state" size="10" class=""/>
                                    <label for="company_state">State</label>
                                </div>
                                <div class="field">
                                    <input type="text" value="<?php echo $user_detail['company_zip']; ?>"
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    <select name="company_country">
                                        <?php if (empty($user_detail[company_country])) {
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    <input type="text" value="<?php echo $user_detail['tax_id']; ?>" name="tax_id"
                                           id="tax_id" size="28" class=""/>
