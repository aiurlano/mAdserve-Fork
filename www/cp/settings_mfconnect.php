                ...
                <?php if (isset ($_GET['failed']) && $_GET['failed'] == 1) { ?>
                    <div class="box plain">
                        <div class="notify notify-error"><h3>Error</h3>
                            ...
                            <p>mAdserve was unable to connect to your MobFox Account. A valid MobFox connection is
                                required for mAdserve to function properly. If you have recently updated your MobFox
                                Account password, please update your user credentials below.</p></div>
                        <!-- .notify --></div>
                <?php } ?>
                <?php if ($updated == 1) { ?>
                    <div class="box plain">
                        <div class="notify notify-success"><h3>Successfully Updated</h3>
                            ...
                            <p>Your MobFox:Connect Settings have successfully been updated.</p></div>
                        <!-- .notify --></div>
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-content">
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    <input type="text" value="<?php echo getconfig_var('mobfox_uid'); ?>"
                                           name="mobfox_uid" id="mobfox_uid" size="28" class=""/> <label
                                        for="mobfox_uid">MobFox Username/E-Mail</label>
                                </div>
                            </div>
                            <!-- .field-group -->
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    <input type="password" value="" placeholder="Enter your MobFox Password..."
                                           name="mobfox_password" id="mobfox_password" size="28" class=""/> <label
                                        for="mobfox_password">MobFox Password</label>
                                </div>
                            </div>
                            <!-- .field-group -->
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    <?php if (mfconcheck(getconfig_var('mobfox_uid'), getconfig_var('mobfox_password'), 1)) {
