                ...
                <?php if ($updated == 1) { ?>
                    <div class="box plain">
                        <div class="notify notify-success"><h3>Successfully Updated</h3>
                            ...
                            <p>Your Settings have successfully been updated.</p></div>
                        <!-- .notify --></div>
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-content">
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    <input type="text" value="<?php echo getconfig_var('adserver_name'); ?>"
                                           name="adserver_name" id="adserver_name" size="28" class=""/>
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    <input type="text" value="<?php echo getconfig_var('server_email'); ?>"
                                           name="server_email" id="server_email" size="28" class=""/>
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    <input id="allow_statistical_info" name="allow_statistical_info"
                                           <?php if (getconfig_var('allow_statistical_info') == 1){ ?>checked="checked"<?php } ?>
                                           type="checkbox" value="1"/>
                                    <label for="allow_statistical_info">Send anonymous statistical information to
                                        madserve.org?</label>
                                </div>
                            </div>
                            <!-- .field-group -->
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    <span
                                        style="margin-left:4px;"><?php echo getconfig_var('installation_id'); ?></span>
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    <span
                                        style="margin-left:4px;"><?php echo getconfig_var('db_install_version'); ?></span>
