                ...
                <?php if ($updated == 1) { ?>
                    <div class="box plain">
                        <div class="notify notify-success"><h3>Success</h3>
                            ...
                            <p>Your Password has successfully been updated.</p></div>
                        <!-- .notify --></div>
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-content">
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    <input type="password" name="current_password" id="current_password" size="28"
                                           class=""/>
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    <input type="password" name="new_password_2" id="new_password_2" size="28"
                                           class=""/>
