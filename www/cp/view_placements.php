    ...
    <div id="content">
        ...
        <div class="container">
            ...
            <div class="grid-24">
                ...
                <div class="actions">
                    <button onclick="window.location='add_placement.php?pubid=<?php echo $_GET['id']; ?>';"
                            class="btn btn-quaternary"><span class="icon-plus"></span>Create New Placement
                    </button>
                </div>
                <!-- .actions -->
