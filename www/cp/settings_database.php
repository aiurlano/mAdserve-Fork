    ...
    <div id="content">
        ...
        <div class="container">
            ...
            <div class="grid-24">
                ...
                <div class="box plain">
                    <div class="notify notify-success"><p>Edit <?php echo MAD_PATH; ?>/conf/main.config.php to change
                            database information.</p></div>
                    <!-- .notify --></div>
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-content">
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    <input disabled="disabled" type="text"
                                           value="<?php echo $GLOBALS['_MAX']['CONF']['database']['host']; ?>"
                                           name="current_password" id="current_password" size="28" class=""/>
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    <input disabled="disabled" type="text"
                                           value="<?php echo $GLOBALS['_MAX']['CONF']['database']['socket']; ?>"
                                           name="current_password" id="current_password" size="28" class=""/>
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    <input disabled="disabled" type="text"
                                           value="<?php echo $GLOBALS['_MAX']['CONF']['database']['username']; ?>"
                                           name="current_password" id="current_password" size="28" class=""/>
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    <input disabled="disabled" type="password"
                                           value="<?php echo $GLOBALS['_MAX']['CONF']['database']['password']; ?>"
                                           name="current_password" id="current_password" size="28" class=""/>
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    <input disabled="disabled" type="text"
                                           value="<?php echo $GLOBALS['_MAX']['CONF']['database']['name']; ?>"
                                           name="current_password" id="current_password" size="28" class=""/>
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-content">
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    Yes <input disabled="disabled" name="rep"
                                               <?php if ($GLOBALS['_MAX']['CONF']['reportingdatabase']['useseparatereportingdatabase'] == true){ ?>checked="checked"<?php } ?>
                                               type="radio" value=""/> No <input
                                        <?php if ($GLOBALS['_MAX']['CONF']['reportingdatabase']['useseparatereportingdatabase'] != true){ ?>checked="checked"<?php } ?>
                                        disabled="disabled" name="rep" type="radio" value=""/>
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    <input disabled="disabled" type="text"
                                           value="<?php echo $GLOBALS['_MAX']['CONF']['reportingdatabase']['host']; ?>"
                                           name="current_password" id="current_password" size="28" class=""/>
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    <input disabled="disabled" type="text"
                                           value="<?php echo $GLOBALS['_MAX']['CONF']['reportingdatabase']['socket']; ?>"
                                           name="current_password" id="current_password" size="28" class=""/>
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    <input disabled="disabled" type="text"
                                           value="<?php echo $GLOBALS['_MAX']['CONF']['reportingdatabase']['username']; ?>"
                                           name="current_password" id="current_password" size="28" class=""/>
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    <input disabled="disabled" type="password"
                                           value="<?php echo $GLOBALS['_MAX']['CONF']['reportingdatabase']['password']; ?>"
                                           name="current_password" id="current_password" size="28" class=""/>
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    <input disabled="disabled" type="text"
                                           value="<?php echo $GLOBALS['_MAX']['CONF']['reportingdatabase']['name']; ?>"
                                           name="current_password" id="current_password" size="28" class=""/>
