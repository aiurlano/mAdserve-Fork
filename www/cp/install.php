            ...
            <div class="grid-24">
                ...
                <?php if (!check_server()) { ?>
                    <div class="notify notify-info">
                        ...
                        <p>You are only one step away from running your very own instance of mAdserve, world's most
                            powerful mobile ad server. mAdserve has performed some checks on your server and there are a
                            couple of thing's you'll need to do before mAdserve can be installed properly.</p>
                    </div> <!-- .notify -->
                <?php } else { ?>
                    <div class="notify notify-success">
                        ...
                        <p>Congratulations! You are only one step away from running your very own instance of mAdserve,
                            world's most powerful mobile ad server. The Server check has been successful. To continue
                            with installation, please click the button below.</p>
                    </div> <!-- .notify -->
                <?php } ?>
                ...
                <?php if (!check_writeable(MAD_PATH . '/conf/')) { ?>
                    <div class="widget">
                        ...
                        <div class="widget-content">
                            <p>In order to continue with installation, please make sure that the directory
                                <strong><?php echo MAD_PATH; ?>/conf/</strong> is writeable. (eg. CHMOD 777)</p>
                        </div>
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-content">
                            <p>This is the directory where mAdserve will store creatives for ad-serving. In order to
                                ...
                                <strong><?php echo MAD_PATH; ?>/data/creative/</strong> is writeable. (eg. CHMOD 777)
                            </p>
                        </div>
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-content">
                            <p>If you'd like to enable File-Based caching to speed up your mAdserve ad server, please
                                make sure that the caching directory <strong><?php echo MAD_PATH; ?>
                ...
                <form method="get" id="installer" name="installer" class="form uniformForm">
                    ...
                    <form method="post" action="install.php" id="installer" name="installer" class="form uniformForm">
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-content">
                                ...
                                <div class="field-group">
                                    ...
                                    <div class="field">
                                        <input type="text" value="<?php if (isset($editdata['server_name'])) {
                                            echo $editdata['server_name'];
                                        } ?>" name="server_name" id="server_name" size="28" class=""/>
                                ...
                                <div class="field-group">
                                    ...
                                    <div class="field">
                                        <input type="text" value="<?php if (isset($editdata['admin_firstname'])) {
                                            echo $editdata['admin_firstname'];
                                        } ?>" name="admin_firstname" id="admin_firstname" size="28" class=""/>
                                ...
                                <div class="field-group">
                                    ...
                                    <div class="field">
                                        <input type="text" value="<?php if (isset($editdata['admin_lastname'])) {
                                            echo $editdata['admin_lastname'];
                                        } ?>" name="admin_lastname" id="admin_lastname" size="28" class=""/>
                                ...
                                <div class="field-group">
                                    ...
                                    <div class="field">
                                        <input type="text" value="<?php if (isset($editdata['admin_email'])) {
                                            echo $editdata['admin_email'];
                                        } ?>" name="admin_email" id="admin_email" size="28" class=""/>
                        ...
                        <div class="actions">
                            <button type="submit" class="btn btn-quaternary btn-large">>> Continue to Database
                                Configuration
                            </button>
                        </div>
                        <!-- .actions -->
                        ...
                        <form method="post" action="install.php" id="installer" name="installer"
                            ...
                            <div class="widget">
                                ...
                                <div class="widget-content">
                                    ...
                                    <div class="field-group">
                                        ...
                                        <div class="field">
                                            <input type="text" value="<?php if (isset($editdata['db_host'])) {
                                                echo $editdata['db_host'];
                                            } ?>" name="db_host" id="db_host" class=""/>
                                    ...
                                    <div class="field-group">
                                        ...
                                        <div class="field">
                                            <input type="text" value="<?php if (isset($editdata['db_name'])) {
                                                echo $editdata['db_name'];
                                            } ?>" name="db_name" id="db_name" class=""/>
                                    ...
                                    <div class="field-group">
                                        ...
                                        <div class="field">
                                            <input type="text" value="<?php if (isset($editdata['db_user'])) {
                                                echo $editdata['db_user'];
                                            } ?>" name="db_user" id="db_user" class=""/>
                                    ...
                                    <div class="field-group">
                                        ...
                                        <div class="field">
                                            <input type="text" value="<?php if (isset($editdata['db_pass'])) {
                                                echo $editdata['db_pass'];
                                            } ?>" name="db_pass" id="db_pass" class=""/>
                            ...
                            <form method="post" action="install.php" id="installer" name="installer"
                                ...
                                <div class="notify notify-info">
                                    ...
                                    <p>By adding your MobFox account details to mAdserve, you will be able to easily
                                        monetize any un-filled traffic through the MobFox:Connect RTB exchange, get
                                        access to real-time traffic requests from over 30 different ad networks,
                                        download additional third party ad network modules right through mAdserve.org,
                                        and get notified immediately about product & security updates from mAdserve.</p>
                                </div>
                                <!-- .notify -->
                                ...
                                <div class="widget">
                                    ...
                                    <div class="widget-content">
                                        ...
                                        <div class="field-group control-group inline">
                                            ...
                                            <div class="field">
                                                <input type="radio"
                                                       onclick="document.getElementById('mobfox_signin').style.display='block'; document.getElementById('mobfox_signup').style.display='none';"
                                                       name="mobfox_connect_type"
                                                       <?php if (!isset($_POST['mobfox_connect_type']) or $_POST['mobfox_connect_type'] == 1){ ?>checked="checked"<?php } ?>
                                                       id="mobfox_one" value="1"/>
                                                <label for="mobfox_one"><em>I have a MobFox.com account</em></label>
                                            </div>

                                            <div id="interstitialoptiobutton" class="field">
                                                <input type="radio"
                                                       onclick="document.getElementById('mobfox_signin').style.display='none'; document.getElementById('mobfox_signup').style.display='block';"
                                                       name="mobfox_connect_type"
                                                       <?php if (isset ($_POST['mobfox_connect_type']) && $_POST['mobfox_connect_type'] == 2){ ?>checked="checked"<?php } ?>
                                                       id="mobfox_two" value="2"/>
                                                <label for="mobfox_two"><em>I do not have a MobFox.com
                                                        account</em></label>
                                            </div>
                                        ...
                                        <div id="mobfox_signin"
                                             style="<?php if (!isset($_POST['mobfox_connect_type']) or $_POST['mobfox_connect_type'] == 1) { ?>display:block;<?php } else { ?>display:none;<?php } ?>">
                                            <div class="field-group">

                                                <div class="field">
                                                    <input type="text" value="<?php if (isset($editdata['mf_user'])) {
                                                        echo $editdata['mf_user'];
                                                    } ?>" name="mf_user" id="mf_user" size="30"/>
                                        ...
                                        <div id="mobfox_signup"
                                             style="<?php if (isset ($_POST['mobfox_connect_type']) && $_POST['mobfox_connect_type'] == 2) { ?>display:block;<?php } else { ?>display:none;<?php } ?>">
                                            <div class="field-group">

                                                <div class="field">
                                                    <input type="text"
                                                           value="<?php if (isset($editdata['mf_first_name'])) {
                                                               echo $editdata['mf_first_name'];
                                                           } ?>" name="mf_first_name" id="mf_first_name" size="30"/>
                                                ...
                                                <div class="field">
                                                    <input type="text"
                                                           value="<?php if (isset($editdata['mf_last_name'])) {
                                                               echo $editdata['mf_last_name'];
                                                           } ?>" name="mf_last_name" id="mf_last_name" size="30"/>
                                            ...
                                            <div class="field-group">
                                                ...
                                                <div class="field">
                                                    <input type="text" value="<?php if (isset($editdata['mf_email'])) {
                                                        echo $editdata['mf_email'];
                                                    } ?>" name="mf_email" id="mf_email" size="30"/>
                                                    <label for="mf_email">E-Mail Address</label>
                                                </div>

                                                <div class="field">
                                                    <input type="text" value="<?php if (isset($editdata['mf_phone'])) {
                                                        echo $editdata['mf_phone'];
                                                    } ?>" name="mf_phone" id="mf_phone" size="30"/>
                                            ...
                                            <div class="field-group">
                                                ...
                                                <div class="field">
                                                    <input type="password" name="mf_password2" id="mf_password2"
                                                           size="30"/>
                                ...
                                <?php if ($mad_install['step'] == 5) { ?>
                                    ...
                                    <div class="notify notify-success">
                                        ...
                                        <p>Congratulations! Your mAdserve installation has completed successfully and
                                            mAdserve is now ready for production use. Please click the below button and
                                            log-in with the Administrator E-Mail and Password you supplied earlier in
                                            the installation process.</p>
                                    </div> <!-- .notify -->

                                    <div class="actions">
                                        <button type="button" onclick="window.location='index.php';"
                                                class="btn btn-quaternary btn-large">>> Sign In Now
                                        </button>
                                    </div> <!-- .actions -->
