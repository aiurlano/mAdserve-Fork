    ...
    <div id="content">
        ...
        <div class="container">
            ...
            <div class="grid-24">
                ...
                <?php if ($edited == 1) { ?>
                    <div class="box plain">
                        <div class="notify notify-success"><h3>Successfully Updated</h3>
                            ...
                            <p>Your Ad Unit has successfully been updated.</p></div>
                        <!-- .notify --></div>
                ...
                <form method="post" enctype="multipart/form-data" id="crudcampaign" name="crudcampaign"
            ...
            <script>
                ...
                ?>
                if (document.forms["crudcampaign"].elements["creative_format"].value != '10') {
