    ...
    <div id="content">
        ...
        <div class="container">
            ...
            <div class="grid-24">
                ...
                <div class="actions">
                    <button onclick="window.location='create_creative_server.php';" class="btn btn-quaternary"><span
                            class="icon-plus"></span>Add New Creative Server
                    </button>
                </div>
                <!-- .actions -->
