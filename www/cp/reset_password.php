...
<div id="login">
    ...
    <div id="login_panel">
        <?php if (isset($_GET['success'])) { ?>
            <div style="margin-top:14px; font-weight:bold; color:#090;" align="center">Please check your e-mail inbox to
                reset your password.
            </div><?php } ?>
        <?php if (isset($_GET['failed'])) { ?>
            <div style="margin-top:14px; font-weight:bold; color:#900;" align="center">Account not found, please try
                again.
            </div><?php } ?>
            ...
            <div class="login_fields">
                <div class="field">
                    <label for="email">Email
                        <small><a href="signin.php">Back to Login</a></small>
                    </label>
