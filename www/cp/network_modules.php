        ...
        <div class="container">
            ...
            <div class="grid-24">
                ...
                <?php if (isset($successmessage)) { ?>
                    <div class="box plain">
                        <div class="notify notify-success"><h3>Success</h3>

                            <p><?php echo $successmessage; ?></p></div>
                        <!-- .notify --></div>
                <?php } ?>
                ...
                <?php if ($user_detail['tooltip_setting'] == 1) { ?>
                    <div class="notify notify-info">
                        ...
                        <p>To install a new ad network, drop the network module into the following directory on your
                            server: <em><?php echo MAD_PATH . "/modules/network_modules/"; ?></em></p>
                    </div> <!-- .notify -->
                <?php } ?>
                    ...
                    <div class="widget-content">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                <th>Module File</th>
                                <th>
                                    <div align="center">XML Configuration</div>
                                </th>
                                <th>
                                    <div align="center">Request Handler</div>
                                </th>
                                <th>
