    ...
    <div id="content">
        ...
        <div class="container">
                ...
                <div class="widget widget-plain">
                    ...
                    <div class="widget-content">
                        ...
                        <div class="dashboard_report first activeState">
                            <div class="pad">
                                <span
                                    class="value"><?php echo number_format($reportingdata_main['total_requests']); ?></span>
                                Ad Requests
                            </div>
                            <!-- .pad -->
                        </div>
                        ...
                        <div class="dashboard_report defaultState">
                            <div class="pad">
                                <span
                                    class="value"><?php echo number_format($reportingdata_main['total_impressions']); ?></span>
                                Impressions
                            </div>
                            <!-- .pad -->
                        </div>
                        ...
                        <div class="dashboard_report defaultState">
                            <div class="pad">
                                <span
                                    class="value"><?php echo number_format($reportingdata_main['total_clicks']); ?></span>
                                Clicks
                            </div>
                            <!-- .pad -->
                        </div>
            ...
            <div class="grid-7">
                ...
                <?php if (get_setup_percentage() < 100) { ?>
                    <div id="gettingStarted" class="box">
                        ...
                        <div class="progress-bar secondary">
                            <div class="bar"
                                 style="width: <?php echo get_setup_percentage(); ?>%;"><?php echo get_setup_percentage(); ?>
                                %
                            </div>
                        </div>

                        <ul class="bullet secondary">
                            <li><a <?php if (check_cron_active()){ ?>style="text-decoration:line-through;"<?php } ?>
                                   target="_blank" href="http://help.madserve.org/cron.php">Set Up Daily Cron Job</a>
                            </li>
                            <li><a <?php if (check_setup('networks')){ ?>style="text-decoration:line-through;"<?php } ?>
                                   href="ad_networks.php">Setup Ad Networks</a></li>
                            <li>
                                <a <?php if (check_setup('publication')){ ?>style="text-decoration:line-through;"<?php } ?>
                                   href="add_publication.php">Add a Publication</a></li>
                            <li><a <?php if (check_setup('campaign')){ ?>style="text-decoration:line-through;"<?php } ?>
                ...
                <a href="../../<?php echo MAD_IOS_SDK_LOCATION; ?>" class="btn btn-primary btn-large dashboard_add">Download
                    iOS SDK</a>
                <a href="../../<?php echo MAD_ANDROID_SDK_LOCATION; ?>"
                   class="btn btn-quaternary btn-large dashboard_add">Download Android SDK</a>
                <!-- .box -->
