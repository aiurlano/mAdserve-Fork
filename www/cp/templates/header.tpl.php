...
<div id="wrapper">
    ...
    <div id="sidebar">
        ...
        <ul id="mainNav">
            <li id="navDashboard" class="nav<?php if ($current_section == "dashboard") {
                echo " active";
            } ?>">
            ...
            <?php if ($user_detail['account_type'] == 1 or ($user_right['view_own_campaigns'] == 1 or $user_right['view_all_campaigns'] == 1 or $user_right['create_campaigns'] == 1)) { ?>
                <li id="navPages" class="nav<?php if ($current_section == "campaigns") {
                    echo " active";
                } ?>">
                    ...
                    <ul class="subNav">
                        <?php if ($user_detail['account_type'] == 1 or ($user_right['view_own_campaigns'] == 1 or $user_right['view_all_campaigns'] == 1)) { ?>
                            <li><a href="view_campaigns.php">View Campaigns</a></li><?php } ?>
                        <?php if ($user_detail['account_type'] == 1 or ($user_right['create_campaigns'] == 1)) { ?>
                            <li><a href="create_campaign.php">+ Create Campaign</a></li><?php } ?>
                    </ul>

                </li>
            <?php } ?>
            <?php if ($user_detail['account_type'] == 1 or ($user_right['view_publications'] == 1 or $user_right['modify_publications'] == 1)) { ?>
                <li id="navForms" class="nav<?php if ($current_section == "inventory") {
                    echo " active";
                } ?>">
                    ...
                    <ul class="subNav">
                        <?php if ($user_detail['account_type'] == 1 or ($user_right['view_publications'] == 1)) { ?>
                            <li><a href="view_publications.php">View Publications</a></li><?php } ?>
                        <?php if ($user_detail['account_type'] == 1 or ($user_right['modify_publications'] == 1)) { ?>
                            <li><a href="add_publication.php">+ Add Publication</a></li>    <?php } ?>
                        <?php if ($user_detail['account_type'] == 1 or ($user_right['modify_publications'] == 1)) { ?>
                            <li><a href="add_placement.php">+ Add Placement</a></li><?php } ?>
                        <?php if ($user_detail['account_type'] == 1 or ($user_right['view_publications'] == 1)) { ?>
            ...
            <?php if ($user_detail['account_type'] == 1 or ($user_right['view_advertisers'] == 1 or $user_right['modify_advertisers'] == 1)) { ?>
                <li id="navGrid" class="nav<?php if ($current_section == "advertisers") {
                    echo " active";
                } ?>">
            ...
            <?php if ($user_detail['account_type'] == 1 or ($user_right['ad_networks'] == 1)) { ?>
                <li id="navButtons" class="nav<?php if ($current_section == "adnetworks") {
                    echo " active";
                } ?>">
            ...
            <?php if ($user_detail['account_type'] == 1 or ($user_right['campaign_reporting'] == 1 or $user_right['own_campaign_reporting'] == 1 or $user_right['publication_reporting'] == 1 or $user_right['network_reporting'] == 1)) { ?>
                <li id="navCharts" class="nav<?php if ($current_section == "reporting") {
                    echo " active";
                } ?>">
                    <span class="icon-chart"></span>
                    <a href="#">Reporting</a>
                    <ul class="subNav">
                        <?php if ($user_detail['account_type'] == 1 or ($user_right['campaign_reporting'] == 1 or $user_right['own_campaign_reporting'] == 1)) { ?>
                            <li><a href="reporting.php?type=campaign">Campaign Reporting</a></li><?php } ?>
                        <?php if ($user_detail['account_type'] == 1 or ($user_right['publication_reporting'] == 1)) { ?>
                            <li><a href="reporting.php?type=publication">Publication Reporting</a></li>    <?php } ?>
                        <?php if ($user_detail['account_type'] == 1 or ($user_right['network_reporting'] == 1)) { ?>
                            <li><a href="reporting.php?type=network">Network Reporting</a></li><?php } ?>
                    </ul>
                </li>
            <?php } ?>
            ...
            <?php if ($user_detail['account_type'] == 1 or ($user_right['configuration'] == 1)) { ?>
                <li id="navInterface" class="nav<?php if ($current_section == "configuration") {
                    echo " active";
                } ?>">
