<div id="topNav">
    <ul>
        <li>
            <a href="#menuProfile"
               class="menu"><?php echo $user_detail['first_name']; ?> <?php echo $user_detail['last_name']; ?> <?php if (!empty($user_detail['company_name'])) {
...
<div id="footer"><?php echo getconfig_var('adserver_name'); ?> - mAdserve <?php echo MAD_VERSION; ?> - Server
    Time: <?php echo date('l jS F Y h:i:s A'); ?>
</div>
