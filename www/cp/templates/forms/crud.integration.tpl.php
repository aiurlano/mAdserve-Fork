...
<?php if ($publication_detail['inv_type'] == 1) { ?>
    <a href="../../<?php echo MAD_IOS_SDK_LOCATION; ?>" class="btn btn-quaternary btn-large dashboard_add">Download iOS
        SDK + Integration Instructions</a>
<?php } ?>
<?php if ($publication_detail['inv_type'] == 2) { ?>
    <a href="../../<?php echo MAD_ANDROID_SDK_LOCATION; ?>" class="btn btn-quaternary btn-large dashboard_add">Download
        Android SDK + Integration Instructions</a>
<?php } ?>