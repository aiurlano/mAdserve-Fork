...
<div class="widget">
    ...
    <div class="widget-content">
        ...
        <div class="field-group">
            <div class="field">
                <input type="text" value="<?php if (isset($editdata['first_name'])) {
                    echo $editdata['first_name'];
                } ?>" name="first_name" id="first_name" size="10" class=""/>
                <label for="first_name"><strong>First Name</strong></label>
            </div>
            <div class="field">
                <input type="text" value="<?php if (isset($editdata['last_name'])) {
                    echo $editdata['last_name'];
                } ?>" name="last_name" id="last_name" size="10" class=""/>
        ...
        <div class="field-group">
            ...
            <div class="field">
                <input type="text" value="<?php if (isset($editdata['email_address'])) {
                    echo $editdata['email_address'];
                } ?>" name="email_address" id="email_address" size="28" class=""/>
                <strong>
        ...
        <div class="field-group">
            ...
            <div class="field">
                <select id="account_type" name="account_type">
                    ...
                    <?php if (!isset($editdata['account_type'])) {
                        $editdata['account_type'] = '';
                    }
                    get_group_dropdown($editdata['account_type']); ?>
                </select>
        ...
        <div class="field-group">
            ...
            <div class="field">
                <input type="text" value="<?php if (isset($editdata['company_name'])) {
                    echo $editdata['company_name'];
                } ?>" name="company_name" id="company_name" size="28" class=""/>
        ...
        <div class="field-group">
            ...
            <div class="field">
                <input type="text" value="<?php if (isset($editdata['phone_number'])) {
                    echo $editdata['phone_number'];
                } ?>" name="phone_number" id="phone_number" size="28" class=""/>
        ...
        <div class="field-group">
            ...
            <div class="field">
                <input type="text" value="<?php if (isset($editdata['fax_number'])) {
                    echo $editdata['fax_number'];
                } ?>" name="fax_number" id="fax_number" size="28" class=""/>
        ...
        <div class="field-group">
            <div class="field">
                <input type="text" value="<?php if (isset($editdata['company_address'])) {
                    echo $editdata['company_address'];
                } ?>" name="company_address" id="company_address" size="20" class=""/>
                <label for="company_address">Address</label>
            </div>
            <div class="field">
                <input type="text" value="<?php if (isset($editdata['company_city'])) {
                    echo $editdata['company_city'];
                } ?>" name="company_city" id="company_city" size="10" class=""/>
        ...
        <div class="field-group">
            <div class="field">
                <input type="text" value="<?php if (isset($editdata['company_state'])) {
                    echo $editdata['company_state'];
                } ?>" name="company_state" id="company_state" size="10" class=""/>
                <label for="company_state">State</label>
            </div>
            <div class="field">
                <input type="text" value="<?php if (isset($editdata['company_zip'])) {
                    echo $editdata['company_zip'];
        ...
        <div class="field-group">
            ...
            <div class="field">
                <select name="company_country">
                    <?php if (!isset ($editdata['company_country']) or empty($editdata['company_country'])) {
        ...
        <div class="field-group">
            ...
            <div class="field">
                <input type="text" value="<?php if (isset($editdata['tax_id'])) {
                    echo $editdata['tax_id'];
                } ?>" name="tax_id" id="tax_id" size="28" class=""/>
