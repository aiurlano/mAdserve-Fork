                ...
                <div class="field-group">
                    ...
                    <div class="field">
                        <select id="reporting_campaign" name="reporting_campaign">
                            ...
                            <?php } ?>
                            <?php if (!isset($_GET['reporting_campaign'])) {
                                $_GET['reporting_campaign'] = '';
                            }
                            get_campaign_dropdown($_GET['reporting_campaign']); ?>
                        </select>
                ...
                <div class="field-group">
                    ...
                    <div class="field">
                        <select id="reporting_publication" name="reporting_publication">
                            ...
                            <?php if (!isset($editdata['reporting_publication'])) {
                                $editdata['reporting_publication'] = '';
                            }
                            get_publication_dropdown_report($editdata['reporting_publication']); ?>
                        </select>
                ...
                <div class="field-group">
                    ...
                    <div class="field">
                        <select id="reporting_network" name="reporting_network">
                            ...
                            <?php if (!isset($editdata['reporting_network'])) {
                                $editdata['reporting_network'] = '';
                            }
                            get_network_dropdown_report($editdata['reporting_network']); ?>
                        </select>
