    ...
    <div class="widget-content">
        ...
        <?php if ($integration_active == 1) { ?>
            ...
            <div class="field-group">
                ...
                <div class="field">
                    <span
                        style="margin-left:4px;"><?php echo MAD_ADSERVING_PROTOCOL . $_SERVER['HTTP_HOST'] . str_replace('/www/cp', '', dirname($_SERVER['PHP_SELF'])) . "/md.request.php"; ?></span>
...
<?php if (!is_numeric($_GET['zone']) or !is_numeric($_GET['publication'])) { ?>
    <div class="box plain">
        <div class="notify notify-warning">
            <p>Please select the publication and placement you would like to integrate above.</p></div>
        <!-- .notify --></div>
<?php } ?>