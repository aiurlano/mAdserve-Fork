...
<div id="wrapper">
    ...
    <div id="sidebar">
        ...
        <ul id="mainNav">
            <li id="navDashboard" class="nav<?php if ($mad_install['step'] == 1) {
                echo " active";
            } ?>">
                <span class="icon-heart-fill"></span>
                <a href="#">Server Check</a>
            </li>
            <li id="navDashboard" class="nav<?php if ($mad_install['step'] == 2) {
                echo " active";
            } ?>">
                <span class="icon-cog"></span>
                <a href="#">Basic Configuration</a>
            </li>
            <li id="navDashboard" class="nav<?php if ($mad_install['step'] == 3) {
                echo " active";
            } ?>">
                <span class="icon-layers"></span>
                <a href="#">Database Information</a>
            </li>
            <li id="navDashboard" class="nav<?php if ($mad_install['step'] == 4) {
                echo " active";
            } ?>">
                <span class="icon-key-stroke"></span>
                <a href="#">Activation</a>
            </li>
            <li id="navDashboard" class="nav<?php if ($mad_install['step'] == 5) {
                echo " active";
            } ?>">
