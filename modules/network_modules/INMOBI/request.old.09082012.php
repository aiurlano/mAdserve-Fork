...
class INMOBI implements networkmodule
{
    public function request($request_type, $request_info, $network_ids, $backfill)
    {
        ...
        if (isset($xml_response->Ads->Ad->ImageURL)) {
            $tempad['image'] = $xml_response->Ads->Ad->ImageURL;
        } else {
            $tempad['image'] = '';
        }
        ...
        if (isset($xml_response->Ads->Ad->BeaconURL)) {
            $tempad['pixel'] = $xml_response->Ads->Ad->BeaconURL;
        } else {
            $tempad['pixel'] = '';
        }
        if (isset($xml_response->Ads->Ad->LinkText)) {
            $tempad['text'] = $xml_response->Ads->Ad->LinkText;
        } else {
            $tempad['text'] = '';
        }
